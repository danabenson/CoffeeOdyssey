...
var MapEditor = function () {
    ...
    self.buildMap = function (callback) {
        ...
        var mapName = 'maps/1.json';
        filesystem.readFile(mapName, function (err, fileContents) {
            if (err) {
                    ...
                    collection.insert({ map: mapData, levelName: levelName }, function (err) {
                        ...
                        collection.count(function (err, count) {
                            ...
                            if (count == 1) {
                                ...
                                logger.info("MongoDB", "Map was rebuilt from " + mapName + " file");
                            }
                        });
                    });
    ...
    }, 60 * 1000); // Save map to Mongo once every minute

};

module.exports = new MapEditor();
